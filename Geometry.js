...
function floor() {
    ...
    floorPoints.push(vertices[0], vertices[1], vertices[2], vertices[0], vertices[2], vertices[3]);
    floorNormals.push(normals[0], normals[1], normals[2], normals[0], normals[2], normals[3]);

    floorData.Point = floorPoints;
    floorData.Normal = floorNormals;
    return floorData;
}
...
function wall() {
    ...
    wallPoints.push(vertices[0], vertices[1], vertices[2], vertices[0], vertices[2], vertices[3]);
    wallNormals.push(normals[0], normals[1], normals[2], normals[0], normals[2], normals[3]);
